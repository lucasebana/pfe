var styles = [ {
  ...
  "style" : [ {
    ...
    "selector" : "node[group = 4]",
    "css" : {
      "background-color" : "rgb(71,45,123)"
    }
  }, {
    "selector" : "node[group > 2][group < 4]",
    "css" : {
      "background-color" : "mapData(group,2,4,rgb(33,145,140),rgb(71,45,123))"
    }
  }, {
    "selector" : "node[group > 0][group < 2]",
    "css" : {
      "background-color" : "mapData(group,0,2,rgb(173,220,48),rgb(33,145,140))"
    }
  }, {
    "selector" : "node[group = 0]",
    "css" : {
